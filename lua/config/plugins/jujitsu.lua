...
return {
    ...
    config = function()
        ...
        jj.setup({
            ...
            cmd = {
                log = {
                    close_on_edit = true, -- close log buffer after editing a change
                },
                describe = {
                    editor = {
                        type = 'buffer',
        ...
        vim.keymap.set('n', '<leader>js', function() picker.status() end, { desc = 'JJ Picker status' })
        vim.keymap.set('n', '<leader>jh', function() picker.file_history() end, { desc = 'JJ Picker history' })
