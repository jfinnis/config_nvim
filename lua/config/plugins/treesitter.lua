...
require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { "javascript", "typescript", "bash", "java", "html", "lua", "json", "c", "vim", "vimdoc", "query", "make", "comment", "css", "diff", "dockerfile", "go", "graphql", "python", "ruby", "sql", "yaml", "gitignore", "gitcommit", "git_config" },
